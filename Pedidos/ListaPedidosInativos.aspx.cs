...
public partial class Pedidos_ListaPedidosInativos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            carregaPedidosSameInativos();
        }
    }
    ...
    {
        Response.Redirect("~/Pedidos/ReportPedidosInativos.aspx");
    }

    protected void carregaPedidosSameInativos()
    {
        try
        {
            GridView1.DataSource = PedidoDAO.CarregaListaPedidosSameInativos();
            GridView1.DataBind();
        }
