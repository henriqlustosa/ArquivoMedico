<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ListaPedidosInativos.aspx.cs" Inherits="Pedidos_ListaPedidosInativos"
    Title="ARQUIVO HSPM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <h1>
        Lista de pedidos de Prontuários/Documentos Inativos</h1>
    <div class="container">
        <div class="x_panel">
            <div class="x_title">
                <h2>
            ...
            <div class="form-group row">
                <div class="col-md-4 col-sm-4 col-xs-8 ">
                    <asp:Button ID="Button2" runat="server" Text="Visualizar Impressão" class="btn btn-warning" OnClick="btnVisImpressao_Click" />
                </div>
            </div>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <asp:RadioButtonList ID="rblStatus" CssClass="radioboxlist" runat="server">
                                                    <asp:ListItem >PENDENTE NÃO ENCONTRADO</asp:ListItem>
                                                    <asp:ListItem>ENCONTRADO</asp:ListItem>
                                                    <asp:ListItem Selected>INATIVO</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                            <div class="form-group">
                                                <asp:Label ID="Label1" for="txbNota" runat="server" Text="Nota:"></asp:Label>
