<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Principal.aspx.cs" Inherits="Principal" Title="ARQUIVO HSPM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
 <div style="text-align: center;">
        <img alt="HSPM" src="../images/HSPM_LOGO.jpg" />
            ...
            <div class="x_panel fixed_height_390">
                <div style="text-align: center;">
                    ...
                    <div class="profile_pic" style="position: relative; top: 50%; left: 50%; margin-left: -50px;">
                        <img src="../images/user.png" alt="..." class="img-circle profile_img" style="border-radius: 50%;"
